...
data class Resource<out DataType>(
    ...
    companion object {
        ...
        fun <DataType> loadingNextPage(): Resource<DataType> = Resource(Status.LOADING_NEXT_PAGE)

        fun <DataType> success(data: DataType? = null): Resource<DataType> = Resource(
            Status.SUCCESS, data = data
        )

        fun <DataType> successNextPage(data: DataType? = null): Resource<DataType> = Resource(
        ...
        fun <DataType> empty(): Resource<DataType> = Resource(Status.EMPTY)
